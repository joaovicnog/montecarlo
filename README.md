...
Este repositório contém a resolução teórica, analítica e computacional completa da atividade sobre o **Método de Monte Carlo**, abordando a estimação de integrais numéricas e a análise probabilística de tensão em sistemas elétricos de distribuição.
